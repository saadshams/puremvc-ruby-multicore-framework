...
module PureMVC
  ...
  module IModel
    ...
    #
    # @param proxy [PureMVC::IProxy] an object reference to be held by the <code>Model</code>.
    ...
    # @return [PureMVC::IProxy] the <code>IProxy</code> instance previously registered with the given <code>proxyName</code>.
